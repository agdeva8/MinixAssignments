/* key.c -- Generated array containing function names.
   ...
   command "/usr/src/gnu/usr.bin/texinfo/makedoc/makedoc".  DO NOT EDIT THIS FILE, only "/usr/src/gnu/usr.bin/texinfo/makedoc/makedoc.c".

   Source files groveled to make this file include:

	/usr/src/gnu/dist/texinfo/info/session.c
	/usr/src/gnu/dist/texinfo/info/echo-area.c
	/usr/src/gnu/dist/texinfo/info/infodoc.c
	/usr/src/gnu/dist/texinfo/info/m-x.c
	/usr/src/gnu/dist/texinfo/info/indices.c
	/usr/src/gnu/dist/texinfo/info/nodemenu.c
	/usr/src/gnu/dist/texinfo/info/footnotes.c
	/usr/src/gnu/dist/texinfo/info/variables.c
...
/* Commands found in "/usr/src/gnu/dist/texinfo/info/session.c". */
...
/* Commands found in "/usr/src/gnu/dist/texinfo/info/echo-area.c". */
...
/* Commands found in "/usr/src/gnu/dist/texinfo/info/infodoc.c". */
